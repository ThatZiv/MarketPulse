...
export function DeleteStock({ ticker, stock_id }: DeleteStockProps) {
  ...
  const handleDelete = async () => {
    if (inputValue === ticker) {
      ...
      toast.error(
        "Stock name does not match. Please enter the correct stock name to delete."
      );
      setInputValue("");
    }
  };
    ...
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader className="flex justify-between items-start">
          ...
          <AlertDialogTitle>
            Are you absolutely sure you want to delete the entire stock history?
          </AlertDialogTitle>
          <AlertDialogDescription>
            ...
            <Alert variant="default" className="mt-4">
              ...
              <AlertDescription>
                <ul className="list-disc pl-5">
                  <li>
                    Your Stock purchase history will be permanently deleted.
                  </li>
                  <li>Stock predictions will be lost.</li>
                  <li>
                    All stored data for {ticker} stock cannot be retrieved.
                  </li>
                  <li>
                    To re-add {ticker} stock, you'll need to enter the stock
                    details again.
                  </li>
                </ul>
              </AlertDescription>
          ...
          <h2 className="text-md pt-3 border-t-2">
            Please enter <span className="font-medium">{ticker} </span>to
        ...
        <AlertDialogFooter>
          <AlertDialogAction
            ...
            className="bg-[#e50000] text-[#e50000]-foreground shadow
                     hover:bg-[#e50000]/90 text-white border-1dark:hover:border-white hover:border-black hover:border-2
                      dark:active:bg-[#e50000]/40 active:bg-[#e50000]/40 w-full"
          >
            I understand the consequences of removing this stock.
          </AlertDialogAction>
        </AlertDialogFooter>
      </AlertDialogContent>
    </AlertDialog>
