...
export default function Feedback() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-transparent text-gray-900 dark:text-white px-6 py-10">
      <Card className="max-w-4xl w-full shadow-lg border-gray-300 dark:border-gray-700 rounded-2xl p-6">
        ...
        <CardContent className="text-left flex flex-wrap gap-4">
          ...
          <div className="w-full">
            <textarea
              ...
              className="min-h-[120px] resize-none border border-gray-300 dark:border-stone-600 p-2 rounded-md w-full bg-white dark:bg-stone-800 text-gray-900 dark:text-white"
              disabled={loading}
            />
          </div>
