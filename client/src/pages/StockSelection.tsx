          ...
          <div className="mb-6">
            ...
            <Select
              ...
              onValueChange={(value: string) =>
                setFormData(prev => ({ ...prev, hasStocks: value, purchases: value === "no" ? [] : prev.purchases }))
              }
              required
            >
              <SelectTrigger>
                ...
                <div key={index} className="flex gap-2 mb-2">
                  <div className="flex-1 flex flex-col">
                    ...
                    <input
                      ...
                      onChange={(e) => handlePurchaseChange(index, 'date', e.target.value)}
                  ...
                  <div className="flex-1 flex flex-col">
                    {index === 0 && (
                      <label htmlFor={`shares-${index}`} className="text-sm mb-1">
                        Shares
                      </label>
                    )}
                    <input
                  ...
                  <div className="flex-1 flex flex-col">
                    {index === 0 && (
                      <label htmlFor={`price-${index}`} className="text-sm mb-1">
                        Price Purchased
                      </label>
                    )}
                    <input
