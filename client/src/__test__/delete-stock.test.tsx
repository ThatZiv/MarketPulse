...
describe("DeleteStock Component", () => {
    ...
    render(
      <MemoryRouter>
        <QueryClientProvider client={queryClient}>
          <DeleteStock ticker="Tesla" stock_id={1} />
          <Toaster />
        </QueryClientProvider>
      </MemoryRouter>
    );
  ...
  test("renders expected text on delete alert dialog box", async () => {
    ...
    const warningDescription =
      "This action cannot be undone. This will permanently delete your stock history and remove your data.";
    ...
    expect(instruction).toHaveTextContent(
      "to confirm the deletion is intentional."
    );
  ...
  test("testing error toast", async () => {
    ...
    const confirmDeleteButton = screen.getByRole("button", {
      name: /I understand the consequences of removing this stock./i,
    });
